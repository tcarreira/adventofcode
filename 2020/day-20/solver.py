#!/usr/bin/env python3
# Not my solution.
# kudos to https://github.com/codertee/adventofcode/blob/main/adventofcode/solutions/y2020/d20_monster.py
...
if __name__ == "__main__":
    with open(curdir.joinpath("input.txt")) as f:
        corners = parse_input(f.read())
    print(solve_first(corners))
    print(solve_second(corners))